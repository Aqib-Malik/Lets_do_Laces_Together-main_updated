...
class LadiesCard extends StatefulWidget {
  LadiesCard({Key? key}) : super(key: key);

  @override
  State<LadiesCard> createState() => _LadiesCardState();
}

class _LadiesCardState extends State<LadiesCard> {
