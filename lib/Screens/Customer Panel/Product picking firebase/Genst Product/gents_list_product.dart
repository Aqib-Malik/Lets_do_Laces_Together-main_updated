...
class GentsListViewShowingCustomerPanel extends StatefulWidget {
  const GentsListViewShowingCustomerPanel({super.key});

  @override
  State<GentsListViewShowingCustomerPanel> createState() =>
      _LadiesGridViewState();
}

final LadiesCardController _LadiesCardController = LadiesCardController();

class _LadiesGridViewState extends State<GentsListViewShowingCustomerPanel> {
